...
interface AddPhonebookEntryDialogProps {
  open: boolean;
  onClose: () => void;
  onAddEntry: (entry: PhoneBookEntry) => void;
}

const defaultEntry: PhoneBookEntry = {
...
const AddPhonebookEntryDialog: React.FC<AddPhonebookEntryDialogProps> = ({
  open,
  onClose,
  onAddEntry,
}) => {
...
export default AddPhonebookEntryDialog;
